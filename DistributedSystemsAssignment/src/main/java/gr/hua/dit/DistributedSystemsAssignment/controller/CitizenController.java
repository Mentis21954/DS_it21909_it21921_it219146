...
public class CitizenController {
		...
		@PostMapping("/save")
		public RedirectView saveUser(@ModelAttribute("application") Application application)
				throws IOException {
			...
			/* this goes to method attributes @RequestParam("image") MultipartFile multipartFile
